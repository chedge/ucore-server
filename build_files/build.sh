...
dnf5 install -y atuin borgbackup borgmatic btop distrobox gdu langpacks-en python3 python3-firewall python3-libselinux python3-libsemanage renameutils man-db mosh yq zsh
